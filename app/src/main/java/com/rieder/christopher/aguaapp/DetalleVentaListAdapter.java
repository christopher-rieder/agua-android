...
public class DetalleVentaListAdapter extends RecyclerView.Adapter<DetalleVentaListAdapter.ViewHolder> {

    private List<DetalleVenta> objects;
    private Context context;

    DetalleVentaListAdapter(Context context, List<DetalleVenta> objects) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(
                LayoutInflater.from(context).inflate(
                        R.layout.detalle_venta_list_item, viewGroup, false));
    }
